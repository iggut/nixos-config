# copied from https://github.com/NixOS/nixpkgs/tree/b51530a54883e994adbbf64e11afe7b359541c8b/pkgs/applications/virtualization/qemu
# i could use overrideAttrs, but i might end up using this for a long time, so for extra safety just copy everything
{
  lib,
  stdenv,
  fetchurl,
